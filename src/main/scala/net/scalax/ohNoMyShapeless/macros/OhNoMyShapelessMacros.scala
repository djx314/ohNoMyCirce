...
object OhNoMyShapelessMacros {
  ...
  class OhNoMyShapelessMacrosImpl(val c: Context) {
    ...
    def impl[Case: c.WeakTypeTag, H: c.WeakTypeTag](hlist: c.Expr[H]): c.Expr[Unit] = {
      ...
      val mg =
        q"""lazy val mg: _root_.net.scalax.ohNoMyShapeless.macros.OhNoMyShapelessMacros.ModelGen[${caseType.typeSymbol}] = new _root_.net.scalax.ohNoMyShapeless.macros.OhNoMyShapelessMacros.ModelGen[${caseType.typeSymbol}] {}"""
